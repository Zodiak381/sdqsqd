  ...
  if (reaction.emoji.name === "⭐") {
    ...
    if (!stars) {
      ...
      if (image === "" && reaction.message.cleanContent.length < 1) return client.errNormal({
        error: `Tu ne peux pas mettre une étoile à un message vide`,
        type: 'ephemeral'
      }, reaction.message);
