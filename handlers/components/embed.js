...
module.exports = (client) => {
    ...
    client.errNormal = async function ({
        ...
        embed.setDescription(`Quelque chose c'est mal passé!`)
        embed.addFields( 
    ...
    client.errUsage = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Erreur!`)
        embed.setDescription(`Tu ne m'as pas donné les bons arguments`)
        embed.addFields(
            { name: "💬┆Arguments réquis", value: `\`\`\`${usage}\`\`\``},    
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errMissingPerms = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Erreur!`)
        embed.setDescription(`Tu n'as pas les permissions réquises`)
        embed.addFields(
            { name: "🔑┆Permissions réquises", value: `\`\`\`${perms}\`\`\``},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errNoPerms = async function ({
        ...
        embed.addFields(
            { name: "🔑┆Permissions requises", value: `\`\`\`${perms}\`\`\``},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.errWait = async function ({
        ...
        embed.setTitle(`${client.emotes.normal.error}・Erreur!`)
        embed.setDescription(`Tu as déjà fait ça`)
        embed.addFields(
            { name: "⏰┆Ressaie dans", value: `<t:${time}:f>`},
        )
        embed.setColor(client.config.colors.error)
    ...
    client.embed = async function ({
        ...
        if (!interaction.guild) interaction.guild = { id: "0" };
