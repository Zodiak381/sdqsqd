        ...
        if (data) {
            ...
            async function endGame() {
                ...
                if (
                    ...
                    gameOver = true;
                    endMsg(`Egalité!`, `Bot a ${dealer.score.toString()}`, `RED`);
                }
            }
            ...
            async function loop() {
                ...
                endMsg(
                    "Pour hit écrit `h`, pour stand écrit `s`",
                    `Bonne Chance ;)`,
                    client.color
                );
