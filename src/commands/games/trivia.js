    ...
    await client.embed({
        ...
        collector.on('collect', async (trivia) => {
            ...
            if (trivia.customId === winningID) {
                ...
                await client.embed({
                    title: `🕹️・Trivia`,
                    desc: `GG, c'était **${question.options[question.correct]}**. Tu as donné la bonne réponse en **${time}**.`,
                ...
                await client.embed({
                    title: `🕹️・Trivia`,
                    desc: `Meilleur chance la prochaine fois, c'était: **${question.options[question.correct]}**.`,
                    components: [{ type: 1, components: [fbtn1, fbtn2, fbtn3, fbtn4] }],
                    type: 'editreply'
                }, interaction)
            }
