    ...
    if (message == "information") {
        client.simpleEmbed({
            ...
            client.embed({
                ...
                fields: [
                    {
                        name: `👋┆Bienvenue dans ${interaction.guild.name}!`,
                        value: `Bienvenue dans notre lieu de rencontre ! Rencontrez de nouvelles personnes ici, jouez à quelques jeux et participez aux événements saisonniers ! Nous sommes un serveur où nous rassemblons tout le monde et nous essayons de le rendre confortable pour tout le monde ! Soyez les bienvenus et amusez-vous !`,
                    },
                    {
                        name: `❓┆Qu'est-ce que je peux faire ici ?`,
                        value: `- Rencontrez de nouvelles personnes ! \n- Jouez à de nombreux jeux amusants ! \n- Découvrez les saisons ! \n- Participez à des événements ! \nEt.... Enfin, choisissez vos propres rôles dans <#1048314874264047646> !`,
                    },
                    {
                        name: `🎫┆Comment je peux être aider si possible?`,
                        value: `Vous pouvez faire un ticket dans <#1048933350578073690> ! Nous sommes heureux de vous aider avec vos questions ici et d'offrir un soutien dans votre serveur!`,
                    }
                ]
            }, interaction.channel)
        })
