    ...
    if (boolean == true) {
        if (Badges) {
            if (Badges.FLAGS.includes(badge.toUpperCase())) return client.errNormal({
                error: `Cette personne a déjà ce badge!`,
                type: `editreply`
            }, interaction);
            ...
            client.succNormal({
                text: `Badge ${badgeFlags[badge.toUpperCase()]} (${badge.toUpperCase()}) ajouté!`,
                type: `editreply`
            }, interaction);
        } else {
        ...
        let embedLogs = new Discord.EmbedBuilder()
            ...
            .setDescription(`Ajouter un nouveau badge à ${member} (${member.id})`)
            .addFields(
        ...
        if (!array[0]) {
            ...
            client.succNormal({
                text: `Badge ${badgeFlags[badge.toUpperCase()]} (${badge.toUpperCase()}) retiré, l'utilisateur a été retiré du système de badge, il n'a plus aucun badge!`,
                type: 'editreply'
            }, interaction);
            ...
            client.succNormal({
                text: `Badge ${badgeFlags[badge.toUpperCase()]} (${badge.toUpperCase()}) retiré!`,
                type: 'editreply'
            }, interaction);
        }
        ...
        let embedLogs = new Discord.EmbedBuilder()
            ...
            .setDescription(`Badge retiré de ${member} (${member.id})`)
            .addFields(
